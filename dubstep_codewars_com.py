# Title: Dubstep
# Source: codewars.com
# Site: https://www.codewars.com/kata/551dc350bf4e526099000ae5
...
# neighbouring words), and then the boy glues together all the words, including "WUB", in one string and plays
...
def song_decoder(song):
    ...
    song = original_song.split()
    song_decoded = ""
    for i in range(len(song)):
        song_decoded = song_decoded + song[i] + " "
