# Title: Mexican Wave
# Source: codewars.com
# Site: https://www.codewars.com/kata/58f5c63f1e26ecda7e000029
...
def wave(message):
    ...
    for num in range(len(message)):
        if message[num].strip() != "":
            final_message.append(message[0:num].lower() + message[num].upper() + message[num+1:].lower())
